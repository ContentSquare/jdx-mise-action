...
function setupWings(): void {
  if (core.getBooleanInput('wings_disabled')) {
    core.exportVariable('MISE_WINGS_ENABLED', '0')
    core.info(
      'mise-wings: forced off via `wings_disabled: true`. Tool installs go direct to upstream origins.'
    )
  }
}
